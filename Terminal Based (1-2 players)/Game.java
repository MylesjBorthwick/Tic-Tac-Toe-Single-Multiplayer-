...
//Game.java
//Created by: Dr. Mosh
//Completed by: Myles Borthwick and Ken Loughery
import java.io.*;
...
public class Game implements Constants {
	...
	static public Player  create_player(String name, char mark, Board board,
		...
		// Get the player type.
		final int NUMBER_OF_TYPES = 5;
		System.out.print ( "\nWhat type of player is " + name + "?\n");
		System.out.print("  1: Human\n" + "  2: Random Player\n"
		+ "  3: Blocking Player\n" + "  4: Smart Player\n"
		//Added an additional bonus class unbeatable
		+ "  5: Unbeatable Player\n");
		...
		switch(player_type) {
			...
			case 5:
				//Bonus Bonus player
				result = new UnbeatablePlayer(name, mark);
				break;
			default:
